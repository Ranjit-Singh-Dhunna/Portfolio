...
# I will replace the exact lines from 945 to 991, which is the inner part of <div className="open-book-right">

base_right_content = r"""                <div className="journal-content" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ flex: 1 }} />
                  <div className="open-book-footer" style={{ width: '100%' }}>
...
# Ensure we escape the literal brackets for regex matching of the exact string:
escaped_content = re.escape(base_right_content)

# We want to replace it with:
# 1. New Base Right inner (Page 10)
# 2. Layer 4 (Pages 8/9)

layer4_html = """              {/* ── 3D TURNING PAGE LAYER 4 (Pages 8 & 9) ── */}
              <motion.div
...
# Perform replacement
content = re.sub(escaped_content, page10_html, content)
